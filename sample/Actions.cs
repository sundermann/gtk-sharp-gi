...
namespace GtkSamples {
	...
	public class Actions {
		...
		static ActionEntry[] entries = new ActionEntry[] {
			...
			new ActionEntry ("cut", Constants.STOCK_CUT, "C_ut", "<control>X",
					 "Cut the selected text to the clipboard",
					 new EventHandler (OnActivate)),
			new ActionEntry ("copy", Constants.STOCK_COPY, "_Copy", "<control>C",
					 "Copy the selected text to the clipboard",
					 new EventHandler (OnActivate)),
			new ActionEntry ("paste", Constants.STOCK_PASTE, "_Paste", "<control>V",
					 "Paste the text from the clipboard",
					 new EventHandler (OnActivate)),
			new ActionEntry ("quit", Constants.STOCK_QUIT, null, "<control>Q",
		...
		static ToggleActionEntry[] toggleEntries = new ToggleActionEntry[] {
			new ToggleActionEntry ("bold", Constants.STOCK_BOLD, "_Bold", "<control>B",
					       "Change to bold face",
		...
		static RadioActionEntry[] radioEntries = new RadioActionEntry[] {
			new RadioActionEntry ("justify-left", Constants.STOCK_JUSTIFY_LEFT, "_Left",
					      "<control>L", "Left justify the text",
					      (int)Justify.Left),
			new RadioActionEntry ("justify-center", Constants.STOCK_JUSTIFY_CENTER, "C_enter",
					      "<control>E", "Center justify the text",
					      (int)Justify.Center),
			new RadioActionEntry ("justify-right", Constants.STOCK_JUSTIFY_RIGHT, "_Right",
					      "<control>R", "Right justify the text",
					      (int)Justify.Right),
			new RadioActionEntry ("justify-fill", Constants.STOCK_JUSTIFY_FILL, "_Fill",
		...
		{
			toolbar.IconSize = (int)IconSize.SmallToolbar;
		}

		static void OnToolbarSizeLarge (object obj, EventArgs args)
		{
			toolbar.IconSize = (int)IconSize.LargeToolbar;
		}
