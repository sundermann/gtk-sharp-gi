...
namespace Gtk {
	public struct ToggleActionEntry {
		...
		public ToggleActionEntry (string name, string stock_id, System.EventHandler activated)
			: this (name, stock_id, null, null, null, activated, false) {}
		
		public ToggleActionEntry (string name, string stock_id, System.EventHandler activated, bool active)
		...
		public ToggleActionEntry (string name, string stock_id, string label,
					  ...
					  System.EventHandler activated, bool active)
		{
			this.name = name;
