...
namespace Gtk {
	public struct ActionEntry {
		...
		public ActionEntry (string name, string stock_id, System.EventHandler activated)
			: this (name, stock_id, null, null, null, activated) {}
		
		public ActionEntry (string name, string stock_id, string label, string accelerator, string tooltip, System.EventHandler activated)
		{
			this.name = name;
