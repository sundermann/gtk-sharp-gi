...
namespace Gtk {
	...
	public partial class ColorSelection {
		...
		static extern IntPtr gtk_color_selection_palette_to_string(out Gdk.Color[] colors, int n_colors);

		public static string PaletteToString(Gdk.Color[] colors) {
			int n_colors = colors.Length;
			IntPtr raw_ret = gtk_color_selection_palette_to_string(out colors, n_colors);
